...
import Sidebar from "../components/Sidebar"; // <-- Replaced here
// import VetSidebar from "../components/VetSidebar"; <-- Removed

const ClientPrescriptionForm = () => {
...
export default ClientPrescriptionForm;
